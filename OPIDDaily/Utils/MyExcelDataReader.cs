        ...
        public static List<DispositionRow> GetResearchRows(string filePath)
        {
            ...
            try
            {
                List<DispositionRow> resRows = new ExcelData(filePath).GetData().Select(dataRow => new DispositionRow
                {
                    ...
                    LBVDOrderDateTwo = (string.IsNullOrEmpty((string)dataRow["LBVD Order Date Two"]) ? epoch : Convert.ToDateTime(dataRow["LBVD Order Date Two"].ToString())),
                    ...
                    LBVDOrderDateThree = (string.IsNullOrEmpty((string)dataRow["LBVD Order Date Three"]) ? epoch : Convert.ToDateTime(dataRow["LBVD Order Date Three"].ToString())),
                    ...
                    TIDOrderDateTwo = (string.IsNullOrEmpty((string)dataRow["TID Order Date Two"]) ? epoch : Convert.ToDateTime(dataRow["TID Order Date Two"].ToString())),
                    ...
                    TIDOrderDateThree = (string.IsNullOrEmpty((string)dataRow["TID Order Date Three"]) ? epoch : Convert.ToDateTime(dataRow["TID Order Date Three"].ToString())),
                    ...
                    TDLOrderDateTwo = (string.IsNullOrEmpty((string)dataRow["TDL Order Date Two"]) ? epoch : Convert.ToDateTime(dataRow["TDL Order Date Two"].ToString())),
                    ...
                    TDLOrderDateThree = (string.IsNullOrEmpty((string)dataRow["TDL Order Date Three"]) ? epoch : Convert.ToDateTime(dataRow["TDL Order Date Three"].ToString())),
                    ...
                    MBVDOrderDateTwo = (string.IsNullOrEmpty((string)dataRow["MBVD Order Date Two"]) ? epoch : Convert.ToDateTime(dataRow["MBVD Order Date Two"].ToString())),
                    ...
                    MBVDOrderDateThree = (string.IsNullOrEmpty((string)dataRow["MBVD Order Date Three"]) ? epoch : Convert.ToDateTime(dataRow["MBVD Order Date Three"].ToString())),
                    ...
                    SDOrderDate2 = (string.IsNullOrEmpty((string)dataRow["SD Order Date Two"]) ? epoch : Convert.ToDateTime(dataRow["SD Order Date Two"].ToString())),
                    ...
                    SDOrderDate3 = (string.IsNullOrEmpty((string)dataRow["SD Order Date Three"]) ? epoch : Convert.ToDateTime(dataRow["SD Order Date Three"].ToString())),
